...
import { Loader2, MessageSquare, RefreshCw, Download, Calendar, Network, Send } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-pink-600 dark:text-pink-400 md:text-3xl">
      ...
      <Card className="border border-gray-200 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900">
        <CardHeader className="space-y-4 p-4 sm:p-6">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-white sm:gap-3 sm:text-xl">
                <MessageSquare className="h-4 w-4 text-pink-500 sm:h-5 sm:w-5" />
                {reportView === "network"
                  ? "Promotional SMS by Network"
                  : "Promotional SMS by Sender ID"}
              </CardTitle>
              <CardDescription className="mt-1 text-xs text-gray-600 dark:text-gray-400 sm:text-sm">
                Detailed SMS performance grouped by{" "}
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-2 rounded-xl border border-pink-200/60 bg-white/80 px-2 py-1 shadow-sm dark:border-pink-800/60 dark:bg-gray-900/60 sm:px-3 sm:py-1.5">
              <Button
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-end">
                <div className="flex-1">
                  <Label className="mb-2 flex items-center gap-2 text-xs font-semibold text-gray-700 dark:text-gray-300 sm:text-sm">
                    <Calendar className="h-3 w-3 text-pink-500 sm:h-4 sm:w-4" />
                    Select Date Range
                  </Label>
                  <DateRangePicker
        ...
        <CardContent>
          ...
          {isError && !isLoading && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <MessageSquare className="mb-4 h-10 w-10 text-red-500" />
          ...
          {!isLoading && !isError && currentReportData.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <MessageSquare className="text-muted-foreground mb-4 h-10 w-10 dark:text-gray-400" />
