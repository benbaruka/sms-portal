...
interface SendScheduledFormProps {
  apiKey: string | null;
}

export default function SendScheduledForm({ apiKey }: SendScheduledFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if ((!selectedDate && !formData.send_date) || !formData.send_time) {
      showAlert({
        variant: "error",
        title: "Error",
    ...
    try {
      ...
      if (dateValue && formData.send_time) {
        ...
        // Extend requestData with scheduled fields
        Object.assign(requestData, {
          send_date: dateValue,
          send_time: normalizedTime, // Format: "HH:mm" (not "HH:mm:ss")
          date: dateValue, // Same as send_date
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-border/50 dark:border-border/30 bg-card border-2 shadow-xl transition-all duration-300 hover:shadow-2xl dark:bg-gray-900/50">
        <CardHeader className="border-border/50 dark:border-border/30 border-b-2 bg-gradient-to-r from-warning-50/50 to-orange-50/50 px-6 py-6 dark:from-warning-950/30 dark:to-orange-950/30">
          <CardTitle className="flex items-center gap-3 text-xl font-semibold text-gray-900 dark:text-white">
            <Clock className="h-5 w-5 text-warning-500" />
            Schedule SMS Form
          </CardTitle>
          <CardDescription className="mt-2 text-gray-600 dark:text-gray-400">
            Fill in the details to schedule an SMS message
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-3">
                ...
                <Input
                  ...
                  required
                  className="border-border/50 h-12 border-2 focus:border-warning-500 focus:ring-2 focus:ring-warning-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-warning-500"
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                {isLoadingSenderIds ? (
                  ...
                  >
                    <SelectTrigger
                      id="sender_id"
                      className="border-border/50 h-12 w-full border-2 focus:border-warning-500 focus:ring-2 focus:ring-warning-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-warning-500"
                    >
            ...
            <div className="space-y-3">
              ...
              <Textarea
                ...
                required
                maxLength={160}
                className="border-border/50 resize-none border-2 focus:border-warning-500 focus:ring-2 focus:ring-warning-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-warning-500"
              />
            ...
            <div className="space-y-6 rounded-xl border-2 border-warning-200/50 bg-gradient-to-r from-warning-50/50 to-orange-50/50 p-8 shadow-lg dark:border-warning-800/50 dark:from-warning-950/30 dark:to-orange-950/30">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    required
                    step="1"
                    className="border-border/50 h-12 rounded-lg border-2 bg-white text-gray-900 focus:border-warning-500 focus:ring-2 focus:ring-warning-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-warning-500"
                  />
                </div>
              </div>
              {(selectedDate || formData.send_date) && formData.send_time && (
                <div className="mt-4 rounded-lg border-2 border-warning-200/50 bg-warning-100/50 p-4 shadow-sm dark:border-warning-800/50 dark:bg-warning-900/30">
            ...
            <div className="border-border/50 dark:border-border/30 mt-6 flex items-center justify-end gap-4 border-t-2 pt-6">
              ...
              <Button
                ...
                className="h-11 bg-gradient-to-r from-warning-500 to-orange-500 px-8 font-semibold text-white shadow-lg transition-all duration-200 hover:from-warning-600 hover:to-orange-600 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50"
              >
