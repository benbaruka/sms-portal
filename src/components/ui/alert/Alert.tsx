      ...
      <div className="flex items-start gap-3">
        ...
        {onDismiss && (
          <button
            ...
            className="-mr-1 -mt-1 ml-2 rounded-md p-1 text-gray-400 transition-colors hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 dark:hover:text-gray-300"
            aria-label="Fermer"
          >
            <X className="h-4 w-4" />
          </button>
