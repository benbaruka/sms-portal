...
import * as service from "../../../../src/controller/query/auth/otp.service";

describe("controller/query/auth/otp.service.ts - Comprehensive Tests", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe("verifyOtp", () => {
    ...
    it("should handle success scenario", async () => {
      ...
      const result = await service.verifyOtp({} as any, apiKey);
    ...
    it("should handle API error", async () => {
      ...
      await expect(service.verifyOtp({} as any, apiKey)).rejects.toThrow();
    });
  ...
  describe("resendOtp", () => {
    ...
    it("should handle success scenario", async () => {
      ...
      const result = await service.resendOtp({} as any, apiKey);
    ...
    it("should handle API error", async () => {
      ...
      await expect(service.resendOtp({} as any, apiKey)).rejects.toThrow();
    });
