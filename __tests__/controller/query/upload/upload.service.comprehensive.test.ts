...
import * as service from "../../../../src/controller/query/upload/upload.service";

describe("controller/query/upload/upload.service.ts - Comprehensive Tests", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe("uploadFile", () => {
    ...
    it("should handle success scenario", async () => {
      ...
      const result = await service.uploadFile({} as any, apiKey);
    ...
    it("should handle API error", async () => {
      ...
      await expect(service.uploadFile({} as any, apiKey)).rejects.toThrow();
    });
